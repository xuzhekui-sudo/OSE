...
#define OSE_MAX_TASKS                       128                           /* 上层的最大任务个�? */
#define OSE_MAX_MAILBOXS                    OSE_MAX_TASKS                 /* 最大邮箱个�? */
#define OSE_MAX_SEMAPHORES                  100                           /* OSE可分配的最大信号量个数 */
#define OSE_MAX_MUTEXES                     200                           /* OSE可分配的最大互斥量个数 */
#define OSE_UNAVAILABLE_ID                  0xFFFFFFFF                    /* 无效�? */
#define OSE_MAX_TIMERS                      5000                          /* 定时器个�? */
#define SEM_VALUE_MAX                       32767                         /* 信号量最大count�? */
